...
other08|pwd101|0|${card_start_time}|${card_end_time}|0|${card_last_time}|0|10000|0
DATA
cp data/cards.txt build/test_state/menu_refund_card_missing.expected_cards.txt
rm -f data/money.txt
