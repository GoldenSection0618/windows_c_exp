...
cancel03|pwd803|1|${card_start_time}|${card_end_time}|0|${card_last_time}|0|10000|0
DATA
cp data/cards.txt build/test_state/menu_cancel_card_online.expected_cards.txt
rm -f data/money.txt
