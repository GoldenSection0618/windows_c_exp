...
refund06|pwd106|2|${card_start_time}|${card_end_time}|0|${card_last_time}|0|10000|0
DATA
cp data/cards.txt build/test_state/menu_refund_card_canceled.expected_cards.txt
rm -f data/money.txt
