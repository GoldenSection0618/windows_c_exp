...
refund02|pwd102|1|${card_start_time}|${card_end_time}|0|${card_last_time}|0|10000|0
DATA
cp data/cards.txt build/test_state/menu_refund_card_online.expected_cards.txt
rm -f data/money.txt
