...
static const NavButtonConfig kAdminNav[] = {
    ...
    {IDC_AMS_NAV_QUERY_CARD, L"下机", true},
    {IDC_AMS_NAV_LOGON, L"充值", true},
    {IDC_AMS_NAV_SETTLE, L"退费", true},
    {IDC_AMS_NAV_RECHARGE, L"营业额统计", true},
    {IDC_AMS_NAV_REFUND, L"退出登录", true},
    {IDC_AMS_NAV_CANCEL_CARD, L"", false},
    {IDC_AMS_NAV_BILLING, L"", false},
    {IDC_AMS_NAV_STAT, L"", false},
    {IDC_AMS_NAV_EXIT, L"", false},
