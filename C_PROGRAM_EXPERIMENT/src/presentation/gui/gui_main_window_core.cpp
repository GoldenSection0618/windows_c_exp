...
static const NavRoute kNavRoutes[] = {
    ...
    {LOGIN_ROLE_ADMIN, IDC_AMS_NAV_QUERY_CARD, NavAction::SwitchMode, GuiMode::AdminStop},
    {LOGIN_ROLE_ADMIN, IDC_AMS_NAV_LOGON, NavAction::SwitchMode, GuiMode::AdminRecharge},
    {LOGIN_ROLE_ADMIN, IDC_AMS_NAV_SETTLE, NavAction::SwitchMode, GuiMode::AdminRefund},
    {LOGIN_ROLE_ADMIN, IDC_AMS_NAV_RECHARGE, NavAction::SwitchMode, GuiMode::AdminStatistics},
    {LOGIN_ROLE_ADMIN, IDC_AMS_NAV_REFUND, NavAction::Logout, GuiMode::AuthAdmin},
